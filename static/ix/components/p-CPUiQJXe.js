...
const Button = /*@__PURE__*/ proxyCustomElement(class Button extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'de117e8374cf25073732e14ced0583a67a53b54b', tabindex: this.disabled ? -1 : 0, class: {
                disabled: this.disabled || this.loading,
            }, onFocus: () => this.setFocus() }, h(BaseButton, Object.assign({ key: '39b6019cede041ff3ea36edebd70001ad7e7228c' }, baseButtonProps), h("slot", { key: '9c59689c0b54defe8a435854dfe4c993de1eb758' }))));
    }
...
//# sourceMappingURL=p-CPUiQJXe.js.map
