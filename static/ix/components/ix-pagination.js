...
import { B as BaseButton } from './p-CEyDHqBY.js';
import { a as a11yBoolean } from './p-Bb7pDeaQ.js';
import { b as iconChevronRightSmall, l as iconChevronLeftSmall } from './p-BdCskL_j.js';
import { d as defineCustomElement$c } from './p-BrRMtQIh.js';
import { d as defineCustomElement$b } from './p-CnWYvVQ3.js';
import { d as defineCustomElement$a } from './p-B9XDeCpV.js';
import { d as defineCustomElement$9 } from './p-Bh9l8HMz.js';
import { d as defineCustomElement$8 } from './p-wwfcx9O8.js';
import { d as defineCustomElement$7 } from './p-CUVSwwVj.js';
import { d as defineCustomElement$6 } from './p-BkmSD6MC.js';
import { d as defineCustomElement$5 } from './p-DFvn_bf5.js';
...
const Pagination = /*@__PURE__*/ proxyCustomElement(class Pagination extends H {
    ...
    render() {
        return (h(Host, { key: 'ab4b74aee5de4a24fe29c8f2d1794e8aba8296e3' }, h("ix-icon-button", { key: '63ffdbc380a049faa31a03b1219fc3a08886daeb', disabled: !this.count || this.selectedPage === 0, ghost: true, icon: iconChevronLeftSmall, onClick: () => this.decrease() }), this.advanced ? (h("div", { class: "advanced-pagination" }, h("ix-typography", { format: "body" }, this.i18nPage), h("input", { class: "ix-form-control page-selection", type: "number", min: "1", max: this.count, value: this.selectedPage + 1, onChange: (event) => {
                const eventTarget = event.target;
                if (eventTarget) {
                    const index = Number.parseInt(eventTarget.value);
                    this.selectPage(index - 1);
                }
            } }), h("span", { class: "total-count" }, h("ix-typography", { format: "body" }, this.i18nOf, " ", this.count)))) : (h("span", { class: "basic-pagination" }, this.renderPageButtons(), " ")), h("ix-icon-button", { key: 'ded752d23bc14a681a7eb607b85f5f5779c5e08a', disabled: !this.count || this.selectedPage === this.count - 1, ghost: true, icon: iconChevronRightSmall, onClick: () => this.increase() }), this.advanced && this.showItemCount ? (h("span", { class: "item-count" }, h("ix-typography", { format: "body" }, this.i18nItems), h("ix-select", { hideListHeader: true, i18nPlaceholder: "", i18nSelectListHeader: "", value: `${this.itemCount}`, onValueChange: (e) => {
