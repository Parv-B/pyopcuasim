...
import { k as iconCalendar } from './p-BdCskL_j.js';
import { D as DateTime } from './p-bDicGJUN.js';
import { d as dropdownController } from './p-D3K9vmFp.js';
import { a as addDisposableChangesAndVisibilityObservers, b as adjustPaddingForStartAndEnd, S as SlotEnd, c as SlotStart } from './p-BRCAzgk8.js';
import { H as HookValidationLifecycle, c as createClassMutationObserver } from './p-aw_FhcJ5.js';
import { m as makeRef } from './p-bcj7UEIC.js';
import { d as defineCustomElement$b } from './p-CPUiQJXe.js';
...
import { d as defineCustomElement$7 } from './p-B9XDeCpV.js';
import { d as defineCustomElement$6 } from './p-Bh9l8HMz.js';
...
const DateInput = /*@__PURE__*/ proxyCustomElement(class DateInput extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["ix-date-input", "ix-button", "ix-date-picker", "ix-date-time-card", "ix-dropdown", "ix-field-label", "ix-field-wrapper", "ix-icon-button", "ix-spinner", "ix-tooltip", "ix-typography"];
...
const IxDateInput = DateInput;
const defineCustomElement = defineCustomElement$1;

export { IxDateInput, defineCustomElement };
//# sourceMappingURL=ix-date-input.js.map
